...
const UserForm = (
  ...
  return (
    <Form className="d-flex mt-5 p-2 mb-5 flex-column colorsettings_bodybackground userform" id="user-form">
      ...
      <div className={`${styles.image_container_size} mb-4`}>
        <Form.Group className={`${styles.image_input_size} mb-3 ms-1 me-1 text-start`}>
        ...
        </Form.Group>
        {
          ...
          ? 
            <div className={styles.container_button_clear}>
              <Button variant="primary" className={styles.button_clear_size} onClick={ handleClearImageClicked }>
                Clear Selection
              </Button>
            </div>
          :
      ...
      }
      {
        ...
        ?
          <div className={`${styles.button_container_size} d-flex justify-content-center`}>
            <Button
              className={`${styles.button_size} ms-5 me-5 colorsettings_buttonfilled`}
              id="button-complete"
              onClick={ handleAddUserClicked }
              type="submit"
              variant="primary"
