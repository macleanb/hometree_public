describe("Demo-0-Self-Registration", () => {
  it("Demo user registration attempt with blank fields", () => {
    ...
    /* Ensure we haven't left the registration page */
    cy.get("div h1").should("have.text", "New User Information").pause();
  });

  it("Demo user registration attempt with improperly-formatted email", () => {
    cy.visit("/");
  ...
  it("Demo user registration attempt with improperly-formatted first name", () => {
    cy.visit("/");
  ...
  it("Demo user registration attempt with improperly-formatted last name", () => {
    cy.visit("/");
  ...
  /* This test will create a basic user on the backend named
     Ada Lovelace. */
  it("Demo the basic functionality of the Self-Registration page: registering a new user", () => {
    cy.visit("/");
  ...
  it("Test user attempt to add duplicate user (user email already exists)", () => {
    ...
    cy.get("[placeholder='Enter last name']").type('Doo');
