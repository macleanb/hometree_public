describe("8b-Residence Manager invalid field inputs", () => {
  it("Test entry of invalid street", () => {
    cy.visit("/");
    ...
    cy.get(".modal-body").should("have.text", "Street: check input (suggest 100 Eden Park Boulevard)");
  ...
  it("Test entry of invalid city", () => {
    ...
    /* Ensure a modal is displayed with appropriate error messages */
    cy.get(".modal-body").should("have.text", "City: check input (suggest Shiloh)");
    cy.get("div button").filter(':contains("Acknowledge")').should("have.length", 1).first().click();
  ...
  it("Test entry of invalid state", () => {
    cy.visit("/");
    ...
    /* Ensure a modal is displayed with appropriate error messages */
    cy.get(".modal-body").should("have.text", "State: check input (suggest IL)");
    cy.get("div button").filter(':contains("Acknowledge")').should("have.length", 1).first().click();
  ...
  it("Test entry of invalid zip", () => {
    ...
    /* Ensure a modal is displayed with appropriate error messages */
    cy.get(".modal-body").should("have.text", "Zip Code: check input (suggest 62269)");
    cy.get("div button").filter(':contains("Acknowledge")').should("have.length", 1).first().click();
