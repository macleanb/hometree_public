describe("8d3-Policy Manager CRUD", () => {
  it("Test the update function of the Policy Manager Page", () => {
    cy.visit("/");
    ...
    cy.get("[placeholder='Enter policy question...']")
      .clear();
    cy.get("[placeholder='Enter policy question...']")
      .type("Should blue fences be allowed?");
    ...
    cy.get(".modal-body").should("have.text", "Policy updated successfully.");
    cy.get("div button")
